...
The complete-force and Coulomb-only development oracles cover this same
Platen sequence. Both reproduce the CPU record exactly in all written rows
and columns; their intentional per-stage transfers exclude them from timing
measurements.
