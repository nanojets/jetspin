...
that capacity growth and device remapping are exercised. The high insertion
speed amplifies GPU rounding, so acceptance checks completion, topology
additions, and a positive reallocation count rather than bead-for-bead
trajectory identity. The input is stored in
